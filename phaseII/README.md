...
<p>
    ...
    Through informal feedback from our engineering team and other colleagues we have learned a lot about what users expect when using a scheduling tool. We now know that a user fully expects a notification or confirmation when they complete a task. With the high cost of college courses, students need a product that they know will work. That is why giving the users a form of feedback is so important. <br><br>
</p>
